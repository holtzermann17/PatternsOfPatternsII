...
\cite{friston2022designing,albarracin2023designing}.  One contribution
this paper makes is to suggest that AIF and DPL can support each
other: AIF can be given a practical and intuitive implementation using
design patterns, and DPL can receive a needed theoretical upgrade from
Active Inference.
