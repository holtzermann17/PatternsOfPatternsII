...
process of working with patterns.  We aim to provide some insights
into what patterns are and how to work with them.  Earlier authors,
such as \citet{moran1971a} and \citet{OXMAN1994141}, looked at the
specifically-computational implementation of design pattern ideas.
Such considerations remains in the background for us, as we focus
primarily on features of implementation at the paper prototype level.
However, we return to questions related to computational
implementation in our discussion.
...
support or refute the value of specific interventions.  These
...
the contributions to the process made by different roles, can help to
understand the need for evolution at the process level.
...
purposes that these methods serve.  Further work would be needed to
fully describe the patterns’ application domains, with evidence of the
...
different perspectives’ (in bold below)\\ 
...
intelligence to articulate action.  In future work it would be
interesting to look further at how this relates to program-specific
design considerations, as described, e.g., by
\citet{felleisen2018design}.
