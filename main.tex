...
\cite{iba2016pattern} provides a large collection of patterns for creating patterns.  We are interested in exploring similar themes (without duplicating that work).
